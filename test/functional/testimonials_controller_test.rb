...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { category: @testimonial.category, firstname: @testimonial.firstname, live: @testimonial.live, testimonial: @testimonial.testimonial }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { category: @testimonial.category, firstname: @testimonial.firstname, live: @testimonial.live, testimonial: @testimonial.testimonial }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
