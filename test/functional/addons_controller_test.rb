...
class AddonsControllerTest < ActionController::TestCase
  ...
  test "should create addon" do
    assert_difference('Addon.count') do
      post :create, addon: { active: @addon.active, details: @addon.details, name: @addon.name, price: @addon.price }
    end
  ...
  test "should update addon" do
    put :update, id: @addon, addon: { active: @addon.active, details: @addon.details, name: @addon.name, price: @addon.price }
    assert_redirected_to addon_path(assigns(:addon))
  end
